...
define config.name = _("All You Zombies")
...
define gui.about = _("""《你们这些还魂尸》

一部基于罗伯特·海因莱因同名小说的原创同人改编视觉小说。

在一家深夜的酒吧里，你将扮演酒保，倾听一位陌生人讲述他不可思议的一生——并通过你的选择，决定如何理解这个关于时间、身份与孤独的故事。
...
define build.name = "AllYouZombies"
