...
screen about():
    ...
    use game_menu(_("关于"), scroll="viewport"):
        ...
        vbox:
            ...
            hbox:
                spacing 15
                text _("原著小说") style "about_small"
                text _("罗伯特·海因莱因《你们这些还魂尸》")
            ...
            grid gui.file_slot_cols gui.file_slot_rows:
                ...
                for i in range(gui.file_slot_cols * gui.file_slot_rows):
                    ...
                    button:
                        ...
                        text FileTime(slot, format=_("{#file_time}%A, %B %d %Y, %H:%M"), empty=_("空档位")):
...
#begin language_picker
                ...
                vbox:
                    ...
                    textbutton "中文" text_font "SourceHanSansLite.ttf" action Language(None)
                    textbutton "English" text_font "SourceHanSansLite.ttf" action Language("english")
